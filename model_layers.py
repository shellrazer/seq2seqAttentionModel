...
class BahdanauAttention(tf.keras.layers.Layer):
    ...
    def call(self, dec_hidden, enc_output, use_coverage=True, prev_coverage=None):
        ...
        if use_coverage and prev_coverage is not None:
            ...
            # attention_weights = masked_attention(attention_weights) #### maked_attention need to define
            coverage = tf.add(attention_weights, prev_coverage)
